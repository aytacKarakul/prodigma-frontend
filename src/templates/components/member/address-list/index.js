export const MemberAddressPopup = () => {
    const selectPopupWrapper = document.querySelector(".member-address-add-popup");
    const addressPopuopVail = document.querySelector(".vail-address-add");
    const selectBtn = document.querySelector("#js-member-page-new-address-add-popup");
    const closeBtn = document.querySelector(".member-address-add-popup-title .icon");
