        ...
        template.innerHTML = `
            ...
            <div class="create-project-right">
                <div class="create-project-right-inner">
                    <div class="create-project-right-name">Prodigma uzmanlarından Endüstriyel Tasarım desteği alın!</div>
                    ...
                    <div class="create-project-right-priting-desc mt-5">
...
const modalFunction = () => {
    ...
    <div class="modal-container">
        ...
        <h1>Endüstriyel Tasarım Fiyat Teklifi</h1>
