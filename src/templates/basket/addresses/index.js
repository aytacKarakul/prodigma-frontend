...
const membershipAdressIndividualSelect = document.querySelector('#js-address-individual-membership');
const membershipAdressCorporateSelect = document.querySelector('#js-address-corporate-membership');
const basketStepWrap = document.querySelectorAll('.basket-address-tab-success-step-selection');
const basketAdressRadioSelection = document.querySelector('.basket-address-tab-success-invoice-content');
...
class BasketAddressInvoiceTab  {
    ...
    init(){
        ...
        membershipAdressIndividualSelect?.addEventListener('click', this.changeAddressTabContent);
        membershipAdressCorporateSelect?.addEventListener('click', this.changeAddressTabContent);
    }
